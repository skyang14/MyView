...
/**
 * Created by yang.shikun on 2020/4/1 13:59
 */
...
public class LyricView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLrcTextSize = typedArray.getDimension(R.styleable.LyricView_lrcTextSize, sp2px(context, 15));
        mLrcLineSpaceHeight = typedArray.getDimension(R.styleable.LyricView_lrcLineSpaceSize, dp2px(context, 20));
        mTouchDelay = typedArray.getInt(R.styleable.LyricView_lrcTouchDelay, 3500);
        mIndicatorTouchDelay = typedArray.getInt(R.styleable.LyricView_indicatorTouchDelay, 2500);
        mNormalColor = typedArray.getColor(R.styleable.LyricView_lrcNormalTextColor, Color.GRAY);
        mCurrentPlayLineColor = typedArray.getColor(R.styleable.LyricView_lrcCurrentTextColor, Color.BLUE);
        mNoLrcTextSize = typedArray.getDimension(R.styleable.LyricView_noLrcTextSize, dp2px(context, 20));
        mNoLrcTextColor = typedArray.getColor(R.styleable.LyricView_noLrcTextColor, Color.BLACK);
        mIndicatorLineWidth = typedArray.getDimension(R.styleable.LyricView_indicatorLineHeight, dp2px(context, 0.5f));
        mIndicatorTextSize = typedArray.getDimension(R.styleable.LyricView_indicatorTextSize, sp2px(context, 13));
        mIndicatorTextColor = typedArray.getColor(R.styleable.LyricView_indicatorTextColor, Color.GRAY);
        mCurrentIndicateLineTextColor = typedArray.getColor(R.styleable.LyricView_currentIndicateLrcColor, Color.GRAY);
        mIndicatorLineColor = typedArray.getColor(R.styleable.LyricView_indicatorLineColor, Color.GRAY);
        mIndicatorMargin = typedArray.getDimension(R.styleable.LyricView_indicatorStartEndMargin, dp2px(context, 5));
        mIconLineGap = typedArray.getDimension(R.styleable.LyricView_iconLineGap, dp2px(context, 3));
        mIconWidth = typedArray.getDimension(R.styleable.LyricView_playIconWidth, dp2px(context, 20));
        mIconHeight = typedArray.getDimension(R.styleable.LyricView_playIconHeight, dp2px(context, 20));
        mPlayDrawable = typedArray.getDrawable(R.styleable.LyricView_playIcon);
        mPlayDrawable = mPlayDrawable == null ? ContextCompat.getDrawable(context, R.drawable.play_icon) : mPlayDrawable;
        isCurrentTextBold = typedArray.getBoolean(R.styleable.LyricView_isLrcCurrentTextBold, false);
        isLrcIndicatorTextBold = typedArray.getBoolean(R.styleable.LyricView_isLrcIndicatorTextBold, false);
        typedArray.recycle();
