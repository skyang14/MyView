...
/**歌词播放view
 * Created by yang.shikun on 2020/4/1 10:20
 */
...
public class LrcView extends View {
    ...
    //private MediaPlayer player;//真正的MediaPlayer
  ...
  /*  public void setPlayer(MediaPlayer player) {
    ...
    public LrcView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        highLineColor = ta.getColor(R.styleable.LrcView_hignLineColor, getResources().getColor(android.R.color.holo_green_light));
