...
/**动态泡泡View
 * Created by yang.shikun on 2020/4/1 9:53
 */
...
//            canvas.drawPath(ripple.path, mPaint);
        }
    }
    ...
    private float randomRadius() {
        return getMeasuredWidth() * 0.01f + random.nextFloat() * getMeasuredWidth() * 0.03f;
    }

    private int randomDuration() {
        return 5000 + random.nextInt(8000);
    }
