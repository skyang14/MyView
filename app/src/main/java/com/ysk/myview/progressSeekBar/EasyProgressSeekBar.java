...
/**
 * Created by yang.shikun on 2020/3/30 11:48
 */

public class EasyProgressSeekBar extends View {
    private static final String TAG = "EasyProgressSeekBar";
    //灰色背景线段的画笔
    ...
    public EasyProgressSeekBar(Context context) {
        super(context);
    }

    public EasyProgressSeekBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EasyProgressSeekBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        L.d("onDraw");
        //绘制背景线段
        Log.e(TAG, "onDraw: "+"paddLeft:" + paddingLeft + " paddRight:" + paddingRight );
